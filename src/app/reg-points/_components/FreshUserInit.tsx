    ...
    if (!dbUser) {
        ...
        return (
            <>
                ...
                <Input id="username" name="username" placeholder="Användarenamn" defaultValue={user.username ? user.username + "" : ""}/>
                <Input type="hidden" id="userId" name="userId" placeholder="userId" defaultValue={user.id}/>
            </>
        )
    }
